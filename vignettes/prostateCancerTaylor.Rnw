...
In this document, I describe how the GEO data entry for the Tayllor Prostate Cancer data was processed and saved into an object for analysis in Bioconductor. First of all load the relevant libraries for grabbing and manipulaing the data
